...
class Hero {
   ...
   update(){
    ...
    for (let enemy of allEnemies) {
        if (this.y === enemy.y && (enemy.x + enemy.step/2 > this.x + this.step/2)) {
            this.reset();
        }
...
//check collison here
//did player x and y collide with an enemy?
//check win here
//did player x and y reach last tile on board?
//reset hero
//set x and y to starting x and y position
const player = new Hero();

//inistialize player varible with hero class
